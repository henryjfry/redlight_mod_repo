...
class FontUtils:
	def execute_custom_fonts(self, skin_files=[]):
		...
		skin_files = skin_files or kodi_utils.list_dirs(kodi_utils.translate_path('special://home/addons/plugin.video.redlight_mod/resources/skins/Default/1080i/'))[1]
	...
	def replace_font(self, window, replacement_values):
		file = kodi_utils.translate_path('special://home/addons/plugin.video.redlight_mod/resources/skins/Default/1080i/' + window)
...
class ExtrasUtils:
	...
	def run(self):
		try:
			...
			file = kodi_utils.translate_path('special://home/addons/plugin.video.redlight_mod/resources/skins/Default/1080i/%s' % skin_file)
